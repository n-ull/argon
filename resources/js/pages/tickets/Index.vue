        ...
        <div class="min-h-screen bg-zinc-950">
            <div class="mx-auto flex w-full max-w-7xl flex-col px-4 py-8 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 class="text-3xl font-bold tracking-tight text-zinc-100">My Tickets</h1>
                ...
                <!-- Filters and Tabs -->
                <div
                    class="mt-8 flex flex-col gap-4 border-b border-zinc-800 pb-6 lg:flex-row lg:items-center lg:justify-between">
                    <!-- Status Tabs -->
                    <div class="flex space-x-1 rounded-xl bg-zinc-800/50 p-1">
                        <button @click="activeTab = 'active'"
                            class="flex items-center rounded-lg px-4 py-2 text-sm font-medium transition-all duration-200"
                            :class="activeTab === 'active' ? 'bg-zinc-900 text-zinc-100 shadow-sm' : 'text-zinc-400 hover:text-zinc-200'">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="relative flex-1 lg:min-w-[240px]">
                            ...
                            <select v-model="selectedEventId"
                                class="block w-full rounded-xl border border-zinc-800 bg-zinc-900 py-2 pl-10 pr-4 text-sm text-zinc-100 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500">
                ...
                <div class="mt-8">
                    ...
                    <!-- Empty State -->
                    <div v-else
                        class="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-zinc-800 py-20">
                        <div class="flex h-16 w-16 items-center justify-center rounded-full bg-zinc-900">
                            <TicketIcon class="h-8 w-8 text-zinc-700" />
                        </div>
