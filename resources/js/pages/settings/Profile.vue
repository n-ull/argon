    ...
    <SimpleLayout>
        ...
        <SettingsLayout>
            <div class="flex flex-col space-y-6">
                <HeadingSmall :title="$t('user.profile_title')" :description="$t('user.profile_description')" />
                ...
                <Form v-bind="ProfileController.update.form()" class="space-y-6"
                    ...
                    <div class="flex justify-end gap-4">
                        ...
                        <Button :disabled="processing" data-test="update-profile-button">{{ $t('user.save') }}</Button>
                    </div>
                </Form>
            </div>

            <DeleteUser class="mt-12" />
        </SettingsLayout>
    </SimpleLayout>
</template>
