...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.connections.legacy.driver' => 'string',
            'database.connections.legacy.host' => 'string',
            'database.connections.legacy.port' => 'string',
            'database.connections.legacy.database' => 'string',
            'database.connections.legacy.username' => 'string',
            'database.connections.legacy.password' => 'string',
            'database.connections.legacy.unix_socket' => 'string',
            'database.connections.legacy.charset' => 'string',
            'database.connections.legacy.collation' => 'string',
            'database.connections.legacy.prefix' => 'string',
            'database.connections.legacy.prefix_indexes' => 'boolean',
            'database.connections.legacy.strict' => 'boolean',
            'database.connections.legacy.engine' => 'NULL',
            ...
            'ddd.layers.Infrastructure' => 'string',
            ...
            'filesystems.links./Users/moovin/Documents/Projects/argon/public/storage' => 'string',
            ...
            'services.mercadopago.app_id' => 'string',
            'services.mercadopago.client_secret' => 'string',
            'services.mercadopago.test_access_token' => 'string',
...
'database.connections.sqlsrv.charset','database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.legacy.driver','database.connections.legacy.host',
'database.connections.legacy.port','database.connections.legacy.database','database.connections.legacy.username','database.connections.legacy.password','database.connections.legacy.unix_socket',
'database.connections.legacy.charset','database.connections.legacy.collation','database.connections.legacy.prefix','database.connections.legacy.prefix_indexes','database.connections.legacy.strict',
'database.connections.legacy.engine','database.migrations.table','database.migrations.update_date_on_publish','database.redis.client','database.redis.options.cluster',
...
'database.redis.cache.backoff_base','database.redis.cache.backoff_cap','ddd.domain_path','ddd.domain_namespace','ddd.application_path',
'ddd.application_namespace','ddd.application_objects','ddd.layers.Infrastructure','ddd.namespaces.model','ddd.namespaces.data_transfer_object',
'ddd.namespaces.view_model','ddd.namespaces.value_object','ddd.namespaces.action','ddd.namespaces.cast','ddd.namespaces.class',
'ddd.namespaces.channel','ddd.namespaces.command','ddd.namespaces.controller','ddd.namespaces.enum','ddd.namespaces.event',
'ddd.namespaces.exception','ddd.namespaces.factory','ddd.namespaces.interface','ddd.namespaces.job','ddd.namespaces.listener',
'ddd.namespaces.mail','ddd.namespaces.middleware','ddd.namespaces.migration','ddd.namespaces.notification','ddd.namespaces.observer',
'ddd.namespaces.policy','ddd.namespaces.provider','ddd.namespaces.resource','ddd.namespaces.request','ddd.namespaces.rule',
'ddd.namespaces.scope','ddd.namespaces.seeder','ddd.namespaces.trait','ddd.base_model','ddd.base_dto',
'ddd.base_view_model','ddd.base_action','ddd.autoload.providers','ddd.autoload.commands','ddd.autoload.policies',
'ddd.autoload.factories','ddd.autoload.migrations','ddd.autoload_ignore','ddd.cache_directory','filesystems.default',
...
'filesystems.disks.s3.report','filesystems.links./Users/moovin/Documents/Projects/argon/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware',
...
'services.ses.secret','services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.mercadopago.access_token',
'services.mercadopago.app_id','services.mercadopago.client_secret','services.mercadopago.test_access_token','session.driver','session.lifetime',
...
'two-factor.regenerate-recovery-codes','telescope',
'home','dashboard','tickets.index','tickets.show','events.index',
'events.show','events.referral.remove','orders.store','orders.checkout','orders.show',
'orders.cancel','orders.payment-intent','orders.register','manage.organizer.create','manage.organizer.create.store',
'manage.organizer.show','manage.organizer.events','manage.organizer.events.store','manage.organizer.cooperators','manage.organizer.settings',
'manage.organizer.settings.update','manage.organizer.taxes-and-fees.store','manage.organizer.taxes-and-fees.update','manage.organizer.taxes-and-fees.destroy','manage.organizer.promoters',
'manage.organizer.promoters.store','manage.organizer.promoters.enable','manage.organizer.promoters.delete','manage.organizer.promoters.invitations.delete','manage.event.dashboard',
'manage.event.analytics','manage.event.analytics.sales','manage.event.analytics.promoters','manage.event.products','manage.event.products.store',
'manage.event.products.delete','manage.event.products.update','manage.event.products.sort','manage.event.products.duplicate','manage.event.combos.store',
'manage.event.combos.update','manage.event.orders','manage.event.settings','manage.event.settings.update','manage.event.attendees',
'manage.event.doormen','manage.event.vouchers','manage.event.promoters.stats','manage.event.status.update','manage.event.courtesies',
'manage.event.courtesies.store','manage.event.courtesies.bulk-delete','manage.event.courtesies.delete','manage.event.scan','promoters.invitations.show',
'promoters.invitations.accept','promoters.invitations.decline','promoters.dashboard','promoters.events.stats','doormen.scanner',
'mp.oauth','mp.webhook','profile.edit','profile.update',
'profile.destroy','user-password.edit','user-password.update','appearance.edit','two-factor.show',
'storage.local',);
        registerArgumentsSet('views', 
'app','emails.auth.guest-created','emails.orders.completed','emails.promoters.commission_completed','emails.promoters.invitation',
'laradumps::output','laradumps::summary','laravel-exceptions::401','laravel-exceptions::402','laravel-exceptions::403',
...
'validation.custom.attribute-name.rule-name','argon.service_fee','argon.dashboard','argon.events','argon.cooperators',
'argon.promoters','argon.settings','argon.tickets','argon.promoter','argon.general',
'argon.manage','argon.clients','argon.attendees','argon.doormen','argon.vouchers',
'argon.courtesies','argon.messages','argon.questions','argon.analytics','argon.products_and_tickets',
'argon.orders','argon.how_to_make_an_event','event.edit_event','event.edit_event_description','event.referral_code_applied',
'event.promoter','event.alt_event_cover','event.alt_event_poster','event.description_not_available','event.organized_by',
'event.sales_start_in','event.sales_end_in','event.sales_ended','event.sales_not_started','event.sales_ended_description',
'event.sales_not_started_description','event.checkout','event.products','event.start_date','event.status',
'event.end_date','event.actions','order.pending_order','order.pending_order_description','order.view_order',
'order.cancel_order','order.reference','order.confirmed_order','order.summary','order.tickets_ready',
'order.tickets_ready_description','order.view_tickets','order.back_to_event','order.confirm_cancelation','order.taxes',
'order.fees','order.total','order.subtotal','order.total_gross','order.time_left',
'order.products','order.selected','order.quantity','order.unit_price','order.taxes_and_fees',
'order.pay','order.confirm','order.mercadopago_is_not_configured','order.mercadopago_is_not_enabled','order.modo_is_not_configured',
'order.modo_is_not_enabled','order.referral_code','order.account','order.checking_as_guest','order.quick_register',
'order.i_have_an_account','order.expired_order','order.expired_order.description','order.cancelled_order','order.cancelled_order.description',
'promoter.invitation_title','promoter.invitation_description','promoter.invitation_description_h2','promoter.your_commission','promoter.per_ticket_sold',
'promoter.logged_in_as','promoter.invite_accepted','promoter.invite_declined','promoter.invite_accepted.description','promoter.invite_declined.description',
'promoter.go_to_dashboard','promoter.please_login','promoter.accept_and_register','promoter.accept_and_register.button','promoter.accept',
'promoter.decline','promoter.copy_link','promoter.details','promoter.link_copied_to_clipboard','promoter.commission.amount',
'promoter.commission.date','promoter.commission.payment_status','promoter.commission.order_status','promoter.dashboard_title','promoter.no_sales',
'promoter.no_sales_description','promoter.total_events','promoter.total_commissions','promoter.my_events','promoter.recent_completed_commissions',
'tickets.my_tickets','tickets.manage_your_tickets_and_access_your_events','tickets.status.active','tickets.status.used','tickets.status.expired',
'tickets.status.inactive','tickets.status.cancelled','tickets.status.courtesy','tickets.all_events','tickets.you_dont_have_any_active_tickets',
'tickets.you_dont_have_any_inactive_tickets','tickets.view_details','tickets.print','tickets.venue','tickets.seat',
'tickets.section','tickets.dynamic','tickets.static','tickets.this_is_courtesy_ticket','tickets.dynamic_ticket_info',
'tickets.scan_for_entry','tickets.refresh_in','tickets.doormen_not_registered','tickets.invalid_totp','tickets.ticket_not_available',
'user.logout','user.login','user.profile','user.two_factor_auth','user.appearance',
'user.settings','user.settings_description','user.password','user.confirm_password','user.confirm_password_description',
'user.confirm_password_button','user.forgot_password','user.forgot_password_description','user.forgot_password_button','user.reset_password',
'user.reset_password_description','user.reset_password_button','user.email','user.or_return_to','user.login_title',
'user.login_description','user.remember_me','user.dont_have_account','user.sign_up','user.register.title',
'user.register.description','user.register.name','user.register.email','user.register.password','user.register.confirm_password',
'user.register.create_account','user.register.already_have_account','user.register.sign_in','user.reset_pw.description','user.reset_pw.password',
'user.reset_pw.confirm_password','user.reset_pw.reset_password','user.reset_pw.title','user.reset_pw.email','user.verify.title',
'user.verify.description','user.verify.resent','user.verify.resent_button','user.verify.back_to_login','argon.actions',
'argon.marquee','argon.welcome.title','argon.og_event_description','argon.og_description','auth.logout',
'auth.login','event.title','event.description','event.not_found','event.combos',
'validation.attributes.start_date','validation.attributes.end_date','validation.attributes.title','validation.attributes.location_info.address','validation.attributes.location_info.city',
'validation.attributes.location_info.state','validation.attributes.location_info.zip','validation.attributes.location_info.country','validation.attributes.location_info.phone','validation.attributes.commission_type',
'validation.attributes.commission_value',);
...
'DB_LEGACY_CONNECTION','DB_LEGACY_HOST','DB_LEGACY_PORT','DB_LEGACY_DATABASE','DB_LEGACY_USERNAME',
'DB_LEGACY_PASSWORD','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH',
...
'MAIL_MAILER','MAIL_SCHEME','MAIL_HOST','MAIL_PORT','MAIL_ENCRYPTION',
...
'MERCADOPAGO_CLIENT_ID','MERCADOPAGO_CLIENT_SECRET','MERCADOPAGO_PUBLIC_KEY','MERCADOPAGO_ACCESS_TOKEN','TEST_MERCADOPAGO_PUBLIC_KEY',
